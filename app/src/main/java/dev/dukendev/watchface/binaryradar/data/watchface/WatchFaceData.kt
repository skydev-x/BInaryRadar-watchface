package dev.dukendev.watchface.binaryradar.data.watchface
...
private const val SECOND_HAND_WIDTH_FRACTION = 0.01f

// Used for corner roundness of the arms.
private const val ROUNDED_RECTANGLE_CORNERS_RADIUS = 2.5f
